...
const FAQs = () => {
  return (
    <div  id="faq" className="bg-MainColor/5 py-16 lg:py-28">
        ...
        <div className="max-w-[900px] mx-auto space-y-5 text-TextColor">
          ...
          <div className="flex items-center justify-center py-6">
            <a
              ...
              className="flex items-center gap-2 bg-MainColor text-TextColor px-4 py-2 md:px-6 md:py-3 rounded-lg outline hover:outline-offset-4 outline-TextColor/5 font-semibold hover:outline-mainColor transition-all text-sm md:text-base"
            >
