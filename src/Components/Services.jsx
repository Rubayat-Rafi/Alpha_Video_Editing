...
import bgfirst from "../assets/bgColor/first.png";

const Services = () => {
  return (
    <div
      id="services"
      className="bg-MainColor/5 py-16 lg:py-28"
    >
      <div className=" max-w-[1440px] mx-auto w-11/12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 mt-8">
          ...
          {/* card 2 */}
          <div className="border bg-secondImage bg-no-repeat bg-right-top bg-cover border-TextColor/20  rounded-2xl py-14 px-6 md:px-14 space-y-4 md:space-y-5 flex flex-col items-center justify-center">
            <h3 className="lg:text-[40px]  md:text-2xl text-xl leading-6 md:leading-9  lg:leading-[46px] font-medium text-center">
              Short Form Contents
            </h3>
            <p className="text-center text-xs leading-5  md:text-sm lg:text-lg text-SecondTextColor md:leading-6 lg:leading-7 md:w-3/6  lg:w-3/4">
          ...
          {/* card 3  */}
          <div className="bg-firstImage bg-left-top bg-cover  bg-no-repeat border border-TextColor/20  rounded-2xl py-14 px-6 md:px-14 space-y-4 md:space-y-5 flex flex-col items-center justify-center">
            <h3 className="lg:text-[40px]  md:text-2xl text-xl leading-6 md:leading-9  lg:leading-[46px] font-medium text-center">
              Podcast Editing
            </h3>
            <p className="text-center text-xs leading-5  md:text-sm lg:text-lg text-SecondTextColor md:leading-6 lg:leading-7 md:w-3/6 lg:w-3/4">
          ...
          {/* card 4 */}
          <div className="bg-secondImage bg-left-top bg-cover  bg-no-repeat border  border-TextColor/20  rounded-2xl py-14 px-8 md:px-14 space-y-4 md:space-y-5 flex flex-col items-center justify-center">
            <h3 className="lg:text-[40px]  md:text-2xl text-xl leading-6 md:leading-9  lg:leading-[46px] font-medium text-center">
